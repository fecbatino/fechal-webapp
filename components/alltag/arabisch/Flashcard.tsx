...
export default function Flashcard({ card, locale, onRate }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 flex flex-col items-center gap-6 min-h-[320px]">
      <div className="text-center flex-1 flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-lg text-gray-500 italic">{card.transliteration}</p>
