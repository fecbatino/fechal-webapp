  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden group">
      ...
      <div className="p-5 space-y-3">
        ...
        {description && (
          <p className="text-sm text-muted-fg line-clamp-3">{description}</p>
        )}
        ...
        <div className="flex flex-wrap gap-1.5">
          {project.tech_stack.map((tech) => (
            <span
              key={tech}
              className="text-xs bg-subtle text-muted-fg px-2 py-1 rounded-md border border-border"
            >
              {tech}
            </span>
          ))}
        ...
        <div className="flex gap-4 pt-2">
          {project.github_url && (
            <a
              ...
              className="text-sm text-muted-fg hover:text-accent transition-colors inline-flex items-center gap-1"
            >
