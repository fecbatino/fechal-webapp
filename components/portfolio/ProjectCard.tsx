      ...
      <div className="p-5 space-y-3">
        ...
        <div className="flex flex-wrap gap-1.5">
          {project.tech_stack.map((tech) => (
            <span
              key={tech}
              className="text-xs bg-white/5 text-gray-400 px-2 py-1 rounded-md border border-white/5"
            >
              {tech}
            </span>
          ))}
        ...
        <div className="flex gap-4 pt-2">
          {project.github_url && (
            <a
              ...
              className="text-sm text-gray-400 hover:text-teal-400 transition-colors inline-flex items-center gap-1"
            >
