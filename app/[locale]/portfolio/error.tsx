  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="glass-card rounded-2xl p-10 max-w-md w-full text-center">
        ...
        <h2 className="text-xl font-bold text-foreground mb-2">Daten konnten nicht geladen werden</h2>
        <p className="text-muted-fg text-sm mb-6">
          Die Verbindung zur Datenbank war nicht erfolgreich. Bitte versuche es erneut.
        </p>
        <button
          onClick={reset}
          className="px-5 py-2.5 rounded-xl bg-accent-light border border-teal-500/30 text-accent hover:bg-accent-light transition-all text-sm font-medium"
        >
          Erneut versuchen
        </button>
      </div>
